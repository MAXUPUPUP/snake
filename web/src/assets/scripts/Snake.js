...
export class Snake extends GameObject {
    constructor(info, gamemap) {
        ...
        this.cells = [new Cell(info.r, info.c)]; //存放蛇身体
        ...
        if(this.id === 1) this.eye_direction = 2; //左下角的眼睛初始向上，右上角的蛇的眼镜初始向下。
    ...
    check_tail_increasing() {//检测当前回合，蛇的长度
    ...
    next_step(){ //将蛇的状态变为走下一步
        ...
        if(!this.gamemap.check_valid(this.next_cell)){//撞了就去世
            this.status = "die";
        }
