package com.game.backend.service.pk.consumer;

import com.alibaba.fastjson2.JSONObject;
import com.game.backend.service.pk.consumer.utils.Game;
import com.game.backend.service.pk.consumer.utils.JwtAuthentication;
import com.game.backend.mapper.BotMapper;
import com.game.backend.mapper.RecordMapper;
...
public class WebSocketServer {
    ...
    public static void startGame(Integer aId, Integer aBotId, Integer bId, Integer bBotId) {
        ...
        Game game = new Game(13, 14, 16, a.getId(), botA, b.getId(), botB);
        game.createMap();
